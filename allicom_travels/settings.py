...
INSTALLED_APPS = [
    ...
    # Third-party
    "rest_framework",
    "rest_framework_simplejwt",  # Simple JWT for Bearer token auth
    "corsheaders",
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        # JWT first (reads Authorization: Bearer <token>)
        "rest_framework_simplejwt.authentication.JWTAuthentication",
        # keep SessionAuthentication for the browsable API and admin session use
        "rest_framework.authentication.SessionAuthentication",
    ],
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.AllowAny",  # users can book without logging in
...
# SIMPLE JWT SETTINGS (sensible defaults; adjust lifetimes as needed)
SIMPLE_JWT = {
