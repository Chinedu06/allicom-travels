...
#     search_fields = ("reference", "booking__id", "booking__given_name", "booking__surname")
...
#         """Pretty print metadata JSON in admin."""
#         if not obj.meta:
#             return "(empty)"
#         import json
#         return format_html(
...
#         )
#     meta_pretty.short_description = "Metadata (JSON)"
...
#                 self.message_user(request, f"Error marking {txn.reference} successful: {e}", level="error")

#     @admin.action(description="Retry verification (re-check with Flutterwave)")
#     def retry_verification(self, request, queryset):
#         """
#         Calls our backend verification service to re-validate the transaction.
#         Works for Flutterwave / external processors.
#         """
#         for txn in queryset:
#             try:
...
#             except Exception as e:
#                 self.message_user(request, f"Error verifying {txn.reference}: {e}", level="error")


# @admin.register(Payment)
# class PaymentAdmin(admin.ModelAdmin):
#     list_display = ("booking_link", "reference", "amount", "provider", "status", "paid_at")
