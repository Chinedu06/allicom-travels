...
class Booking(models.Model):
    ...
    # uploads saved under MEDIA_ROOT/bookings/proofs/
    # proof_document = models.FileField(upload_to='bookings/proofs/')
    proof_document = models.FileField(upload_to='bookings/proofs/', null=True, blank=True)
